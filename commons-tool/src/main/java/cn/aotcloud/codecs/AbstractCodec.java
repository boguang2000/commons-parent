...
public abstract class AbstractCodec<T> implements Codec<T> {
	...
	/**
	 * WARNING!! {@code Character} based Codecs will silently transform code points
	 * that are not legal UTF code points into garbage data as they will cast them
	 * to {@code char}s. </br>
	 * </br>
	 * If you are implementing an {@code Integer} based codec, these will be
	 * silently discarded based on the return from
	 * {@code Character.isValidCodePoint( int )}. This is the preferred behavior
	 * moving forward.
	 * 
	 * 
	 * {@inheritDoc}
	 ...
	 * 
	 * @see #encodeCharacter( char[], int ) method instead of this one!!! YOU HAVE
	 *      BEEN WARNED!!!!
	 * 
	 *      {@inheritDoc}
	 */
	...
	public String encodeCharacter(char[] immune, char c) {
		throw new IllegalArgumentException(
				"You tried to call encodeCharacter with a char.  Nope.  Use Character instead!");
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.owasp.esapi.codecs.Codec#decodeCharacter(org.owasp.esapi.codecs.
	 * PushbackString)
	 */
	@Override

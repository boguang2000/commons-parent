...
public class PercentCodec extends AbstractCharacterCodec {
	...
	private static final Set<Character> UNENCODED_SET = CollectionUtils.strToUnmodifiableSet(UNENCODED_STR);
	 ...
	 * throws in a {@link IllegalStateException} as UTF-8 support is required by the
	 * Java spec and should never throw this exception.
	 * 
	 * @param str the string to encode
	 * @return str encoded in UTF-8 as bytes.
	 * @throws IllegalStateException wrapped {@link UnsupportedEncodingException} if
	 ...
	 * 
	 * @param immune Additional characters not to encode. Note this could break URL
	 *               encoding as referenced in RFC 3986. You should especially be
	 *               wary of including '%' in this list of immune characters since
	 *               it is used as the "escape" character for the hex encoding and
	 *               including it may result in subsequent and/or dangerous results
	 *               when decoding.

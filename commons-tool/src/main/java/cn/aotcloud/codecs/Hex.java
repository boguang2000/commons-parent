...
public class Hex {
	...
	/**
	 * Output byte representation as hexadecimal representation. Alias for
	 * <code>toHex()</code> method.
	 * 
	 * @param b         Bytes to encode to hexadecimal representation.
	 * @param leading0x If true, return with leading "0x".
	 * @return Hexadecimal representation of specified bytes.
	...
	/**
	 * Decode hexadecimal-encoded string and return raw byte array. Important note:
	 * This method preserves leading 0 filled bytes on the conversion process, which
	 * is important for cryptographic operations in dealing with things like keys,
	 * initialization vectors, etc. For example, the string "0x0000face" is going to
	 * return a byte array whose length is 4, not 2.
	 * 
	...
	/**
	 * Decode hexadecimal-encoded string and return raw byte array. Alias for
	 * <code>fromHex()</code> method.
	 * 
	 * @param hexStr Hexadecimal-encoded string, with or without leading "0x".
	 * @return The equivalent byte array.
	 */

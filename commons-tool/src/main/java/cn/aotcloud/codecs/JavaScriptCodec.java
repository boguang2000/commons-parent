...
public class JavaScriptCodec extends AbstractCharacterCodec {
	 ...
	 * {@inheritDoc}
	 * 
	 * Returns backslash encoded numeric format. Does not use backslash character
	 * escapes such as, \" or \' as these may cause parsing problems. For example,
	 * if a javascript attribute, such as onmouseover, contains a \" that will close
	 * the entire attribute and allow an attacker to inject another script
	 * attribute.
	 *
	 * @param immune
	 */
	 ...
	 * decoding is possible. See
	 * http://www.planetpdf.com/codecuts/pdfs/tutorial/jsspec.pdf Formats all are
	 * legal both upper/lower case: \\a - special characters \\xHH \\uHHHH \\OOO (1,
	 * 2, or 3 digits)
	 */

...
public class XMLEntityCodec extends AbstractCharacterCodec {
	 ...
	 * 
	 * @param input The input to read from. It is assumed that input is positioned
	 *              at the character after the &amp;#
	 ...
	 * 
	 * @param i the integer
	 * @return i as a Character or null if i is a invalid code point or outside of
	 *         the Java char range.
	 */
	 ...
	 * 
	 * @param input The input to read from. It is assumed that input is positioned
	 *              at the character after the &amp;# and that the next char is not
	 *              a 'x' or 'X'.
	...
	/**
	 * 
	 * Converts the rest of a named entity to a character. null if no decoding is
	 * possible.
	 * 
	 * @param input The input to read from. It is assumed that input is positioned
	 *              at the character after the &amp;.

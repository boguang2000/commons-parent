...
import cn.aotcloud.oauth2.altu.oauth2.common.OAuthProviderType;
...
import cn.aotcloud.oauth2.altu.oauth2.common.parameters.BodyURLEncodedParametersApplier;
import cn.aotcloud.oauth2.altu.oauth2.common.parameters.OAuthParametersApplier;
import cn.aotcloud.oauth2.altu.oauth2.common.parameters.QueryParameterApplier;
...
public class OAuthClientRequest implements OAuthMessage {
    ...
    public static class TokenRequestBuilder extends OAuthRequestBuilder {
        ...
        public TokenRequestBuilder setClientPscode(String pscode) {
            this.parameters.put(OAuth.OAUTH_CLIENT_SECRET, pscode);
            return this;
        }
        ...
        public TokenRequestBuilder setPassword(String password) {
            this.parameters.put(OAuth.OAUTH_AUTHKEY, password);
            return this;
        }
